...
public class DoatLookState : SubState
{
    ...
    public DoatLookState(BossStateMachine stateMachine, MainState parent, ActionPattern attackPattern = null) : base(stateMachine, parent)
    {
    ...
    public override void Update()
    {
        ...
        if(rate > 1f)
        {
            ...
            {
                parent.ChangeSubState(new DoatAttackState(stateMachine, parent, attackPattern as AttackPattern));
                return;
            }
            else
            {
