...
public class LaviesLookState : SubState
{
    ...
    public LaviesLookState(BossStateMachine stateMachine, MainState parent, ActionPattern attackPattern = null) : base(stateMachine, parent)
    {
    ...
    public override void Update()
    {
        ...
        if (rate > 1f)
        {
            ...
            {
                parent.ChangeSubState(new LaviesAttackState(stateMachine, parent, attackPattern as AttackPattern));
                return;
            }
            else
            {
