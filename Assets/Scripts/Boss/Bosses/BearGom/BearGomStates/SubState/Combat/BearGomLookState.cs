...
public class BearGomLookState : SubState
{
    ...
    public BearGomLookState(BossStateMachine stateMachine, MainState parent, ActionPattern attackPattern) : base(stateMachine, parent)
    {
    ...
    public override void Update()
    {
        ...
        if (rate > 1f)
        {
            parent.ChangeSubState(new BearGomAttackState(stateMachine, parent, attackPattern as AttackPattern));
            return;
        }
    }
}
